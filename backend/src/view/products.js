const produtosView = (produtos)=>{
    ...
    if(typeof(produtos) == 'string'){
        ...
        produtos.forEach(produto=>{
            ...
            <div class="card m-5 p-3" style="width: 18rem;">
                ...
                <div class="card-body align-items-end">
                    <input type="button" name="editarCliente" class="card-link btn-lg btn-block banana-btn align-self-end"" value="Editar" data-toggle="modal" data-target="#modalEdit${produto.id_product}" />
                    <!-- Modal Editar -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <form id="deletarCliente" action="" method="POST">
                        ...
                        <input type="hidden" name="id_product" value="${produto.id_product}" />
                        <input type="submit" class="card-link btn-lg btn-block banana-btn align-self-end" value="Remover" />
                    </form>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="supplier" role="tabpanel" aria-labelledby="profile-tab">
            ...
            <!-- Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="md-form mb-5">
                        <i class="fas fa-id-card-alt prefix grey-text"></i>
                        <input name="id_provider" id="inputProvider" type="text" class="form-control">
                        <label for="id_provider">Id fornecedor</label>
                    </div>
                    
                    <div class="md-form mb-5">
                        <i class="fab fa-readme prefix grey-text"></i>
                        <input name="description" id="inputDescription" type="text" class="form-control">
                        <label for="inputDescription">Descrição</label>
                    </div>
    
                    <div class="md-form mb-5">
                        <i class="far fa-chart-bar prefix grey-text"></i>
                        <input name="evaluation" id="inputEvaluation" type="text" class="form-control">
                        <label for="inputEvaluation">Avaliação</label>
                    </div>
                    
                    <div class="md-form mb-5">
                        <i class="fas fa-dollar-sign prefix grey-text"></i>   
                        <input name="price" id="inputPrice" type="text" class="form-control">
                        <label for="inputPrice">Preço</label>
                    </div>
                    
                    <div class="md-form mb-5">
                        <i class="fas fa-calculator prefix grey-text"></i>
                        <input name="quantity" id="inputQuantity" type="number" class="form-control">
                        <label for="inputQuantity">Quantity</label>
                    </div>
        ...
        <section class="main d-flex justify-content-around flex-wrap">
        <!--USER-->
        <!--Aqui entra o card de perfil do produto-->
